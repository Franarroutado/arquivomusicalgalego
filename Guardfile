...
guard :concat, :type => "css", :files => %w[bar theme elements], :input_dir => "public/css", :output => "public/assets/css/styles.min"
...
guard :sass, :input => 'app/assets/sass', :output => 'public/assets/css'