...
@section('content')
  ...
  <div class="btn-group">
      ...
      <a href="{{ route('dashboard.materiales.create') }}" class="btn btn-primary"><i class="icon-plus"></i> @lang('button.new_entity', ['entity' => trans('button.material')])</a>
  </div>
</div>
<div class="well">
    {{ Form::open(['route' => 'dashboard.materiales.index', 'method' => 'GET', 'id' => 'searchForm', 'class' => 'navbar-search .pull-right']) }}
