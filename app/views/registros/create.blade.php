    ...
    <div class="row-fluid">
      {{ Form::open(array('method' => 'POST', 'route' => array('dashboard.registros.store'))) }}
        ...
        <div class="well">
              ...
              {{ Form::select('tipo', ['-1' => 'Elixa un tipo',
                                        'ORIXINAL' => 'ORIXINAL',
                                        'COPIA' => 'COPIA',
                                        'ARRANXO' => 'ARRANXO',
              ...
              {{ Form::text('centro', null, ['autocomplete'=>'off','class' => 'input-xlarge', 'id' => 'centro']) }}
              ...
              {{ Form::text('fondo', null, ['class' => 'input-xlarge']) }}
              {{ Form::label('edicion', trans('app.files.edition').":") }}
              {{ Form::text('edicion', null, ['class' => 'input-xlarge']) }}
