...
@section('content')
  ...
  <div class="btn-group">
      ...
      <a href="{{ route('dashboard.registros.create') }}" class="btn btn-primary"><i class="icon-plus"></i> @lang('button.new_entity', array('entity' => trans('button.file')))</a>
  </div>
</div>
<div class="well">
    {{ Form::open(array('route' => 'dashboard.registros.index', 'method' => 'GET', 'id' => 'searchForm', 'class' => 'navbar-search .pull-right')) }}
