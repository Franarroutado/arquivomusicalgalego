    ...
    <div class="navbar">
        <div class="navbar-inner">
                <ul class="nav pull-right">
                    ...
                    <li><a href="#" class="hidden-phone visible-tablet visible-desktop" role="button">{{ trans('menu.settings') }}</a></li>
                    <li id="fat-menu" class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a tabindex="-1" href="#">{{ trans('menu.account') }}</a></li>
                            <li class="divider"></li>
                            <li><a tabindex="-1" class="visible-phone" href="#">Settings</a></li>
                            <li class="divider visible-phone"></li>
                            <li><a tabindex="-1" href="sign-in.html">{{ trans('menu.signout') }}</a></li>
                        </ul>
                    </li>
                    
                </ul>
                <a class="brand" href="index.html">
                  <span class="first">{{ trans('app.title') }}</span> <span class="second">ARQUIVO BANDA DE MUSICA MUNICIPAL DE SILLEDA</span>
                </a>
        </div>
    </div>
...
<div class="row-fluid">
    ...
    <div class="alert alert-info">
        ...
        <strong>Just ranom note:</strong> Hope you like the theme!
    </div>
